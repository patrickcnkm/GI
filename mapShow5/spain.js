...
var b = { left: a.left + (a.right - a.left) / 2, top: a.top + (a.bottom - a.top) / 2 }
...
function clickedbig(s) {
  ...
  */
  ...
  groups.transition()
      .duration(750)
      .attr("transform", "translate(" + width / 2 + "," + height / 2 + ")scale(" + k + ")translate(" + -tranX + "," + -tranY + ")")
  } else {
    groups.transition()
      .duration(750)
      .attr("transform", "translate(" + width * -(k-1)/2 + "," + height * -(k-1)/2 + ")scale(" + k + ")")  
  }
}
...
function clickedsmall() {
  ...
  groups.transition()
    ...
    groups.transition()
      .duration(750)
      .attr("transform", "translate(" + width * (1-k)/2 + "," + height * (1-k)/2 + ")scale(" + k + ")")  
  }
